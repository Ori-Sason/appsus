...
export class NoteBtns extends React.Component {
    ...
    render() {
        ...
        return <section className="note-btns">
            <button type="button" title="Reminder" className="note-btn img-reminder clean-btn" onClick={(ev) => onReminder(ev, noteId)}></button>
            <button type="button" title="Background color" className="note-btn img-color clean-btn" onMouseDown={this.onOpenColorPicker} onClick={(ev) => ev.stopPropagation()}></button>
